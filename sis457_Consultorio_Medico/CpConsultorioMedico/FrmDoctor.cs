...
namespace CpConsultorioMedico
{
    public partial class FrmDoctor : Form
    {
        ...
        {
            Size = new Size(840, 462); // Tamaño inicial solo lista
            gbxDatos.Visible = false;   // Oculta la sección de Datos al inicio
            listar();
        ...
        {
            esNuevo = true;
            gbxDatos.Visible = true;       // Mostrar la sección de Datos
            Size = new Size(840, 687);     // Ajustar tamaño del formulario
            limpiar();                      // Limpiar campos antes de agregar
        ...
        {
            gbxDatos.Visible = false;       // Ocultar la sección de Datos
            Size = new Size(840, 462);      // Volver al tamaño inicial
            limpiar();
        }
        ...
        private void lblEspecilaidad_Click(object sender, EventArgs e)
        {
