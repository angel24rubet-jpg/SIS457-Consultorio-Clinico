...
using CpMinerva; // <- Para acceder a Util
using ClnConsultorioMedico; // <- Para usar PacienteCln, EspecialidadCln, DoctorCln
...
namespace CpConsultorioMedico
{
    public partial class FrmHistorial : Form
    {
        ...
        public FrmHistorial()
        {
            ...
            // Inicia con el panel de datos oculto
            gbxDatos.Visible = false;

            // Enlazo eventos de botones y controles
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            // Mostrar panel de datos para nueva entrada
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            using (var ctx = new LabConsultorioMedicoEntities())
            {
                ...
                if (reg != null)
                {
                    ...
                    // Si tienes especialidad/doctor en la BD
                    // cargarEspecialidades();
